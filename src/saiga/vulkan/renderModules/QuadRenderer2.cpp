...
bool QuadRenderer2::bind(vk::CommandBuffer cmd)
{
...
void QuadRenderer2::updateUniformBuffers(vk::CommandBuffer cmd, mat4 view, mat4 proj)
{
...
void QuadRenderer2::init(VulkanBase& vulkanDevice, VkRenderPass renderPass)
{
...
void QuadRenderer2::createAndUpdateDescriptorSet(Saiga::Vulkan::Memory::ImageMemoryLocation* diffuse,
