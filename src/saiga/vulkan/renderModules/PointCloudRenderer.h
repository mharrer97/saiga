...
class SAIGA_VULKAN_API DeferredPointCloudRenderer : public Pipeline
{
   public:
    using VertexType = VertexNC;
    ~DeferredPointCloudRenderer() { destroy(); }
    void destroy();
...
class SAIGA_VULKAN_API ShadowPointCloudRenderer : public Pipeline
{
   public:
    using VertexType = VertexNC;
    ~ShadowPointCloudRenderer() { destroy(); }
    void destroy();
