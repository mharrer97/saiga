...
namespace Vulkan
{
class SAIGA_VULKAN_API TestRenderer : public Pipeline
{
   public:
     ...
     */
    void render(vk::CommandBuffer cmd, DescriptorSet& descriptor, vec2 position, vec2 size);
    ...
    StaticDescriptorSet createAndUpdateDescriptorSet(Saiga::Vulkan::Memory::ImageMemoryLocation* diffuse,
